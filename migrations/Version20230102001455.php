 ...
 */
final class Version20230102001455 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE produit (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, url_video_youtube VARCHAR(255) DEFAULT NULL, prix_vente DOUBLE PRECISION NOT NULL, qte_stock INT NOT NULL, qte_alerte INT NOT NULL, couleur VARCHAR(255) DEFAULT NULL, code VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', is_arrivage TINYINT(1) NOT NULL, is_best_selling TINYINT(1) NOT NULL, photo_principale VARCHAR(255) NOT NULL, is_solde TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
